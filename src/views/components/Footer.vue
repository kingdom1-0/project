  ...
  >
    <div class="fo_content">
          ...
          <div class="fo_ulBl">
            ...
            <div class="fo_liBl">
              ...
              <div class="fo_ul">
                ...
                <router-link
                  to="/contentUs/traffic"
                  class="fo_li"
                >
                  交通指南
                </router-link>
                <router-link
                  to="/contentUs/attract"
                  class="fo_li"
                >
                  招商租赁
                </router-link>
      ...
      <div class="fo_boBlock">
        ...
        <div class="fo_boRi">
          <router-link to="/contentUs/contactUs">
            联系我们
          ...
          >
            ...
            <div class="outNav">
              <a
                href="http://www.g-cre.com/"
                target="_blank"
              >星河商置</a>
              <a
                href="http://ft.cocopark.cn/"
                target="_blank"
              >深圳福田星河COCO Park</a>
              <a
                href="http://lg.cocopark.cn/"
                target="_blank"
              >深圳龙岗星河COCO Park</a>
              <a
                href="http://szworld.cocopark.cn/"
                target="_blank"
              >星河WORLD·COCO Park</a>
              <a
                href="http://szlh.xhcococity.com/"
                target="_blank"
              >深圳龙华星河COCO City</a>
              <a
                href="http://cz.xhcococity.com/"
                target="_blank"
              >常州星河COCO City</a>
              <a
                href="http://pn.xhcococity.com/"
                target="_blank"
              >普宁星河COCO City</a>
              <a
                href="http://www.icosz.com/Operation/Default.aspx"
                target="_blank"
              >龙华星河iCO</a>
              <a
                href="http://www.topliving.cn/"
                target="_blank"
              >星河第三空间</a>
              <div class="foa_null" />
            </div>
