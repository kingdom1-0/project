          ...
          <el-row :gutter="20">
            <el-col :span="22">
              <el-menu class="el-menu-demo" mode="horizontal" background-color="#545c64" text-color="#fff"
                ...
                <el-submenu index="1">
                  <template slot="title"><i class="el-icon-s-home" style="opacity:0.9"></i>首页</template>
                  <el-menu-item index="1-1"><i class="el-icon-info"></i>系统信息</el-menu-item>
                  <el-menu-item index="1-2"><i class="el-icon-s-marketing"></i>统计流量</el-menu-item>
                </el-submenu>
                <el-menu-item index="2"><a href="javascript:;"><i class="el-icon-document-copy"></i>内容管理</a>
                </el-menu-item>
                <el-submenu index="3">
            ...
            <el-col :span="2" style="text-align: right;">
              <el-dropdown>
                <span class="el-dropdown-link">
                  <i class="el-icon-s-custom" style="margin-right: 10px;"></i>admin
                </span>
    ...
    methods: {      
      ...
      logIn() {
        this.$refs.formRef.validate(async value => {//表单预验证
          ...
          //登陆验证          
          const {data:res} = await this.$http.post("login",this.form)//this.form要对应API文档约定命名（username、password）
